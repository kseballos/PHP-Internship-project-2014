...
<head>
  ...
  <div class="col-lg-12">
	   ...
	   <div class="heading">
        <i class="icon-reorder"></i>Approve Requests
...
<?php
	...
	if(isset($_POST['cancel'])){
		...
		$sql= "UPDATE requestpost SET statusid='CANCELLED' where prioritynumber ='$p' ";
		}else  {
		$sql= "UPDATE requestpost SET statusid='CANCELLED' where prioritynumber ='$p' ";
    }
	}else {
	if(empty($_POST['cost']) && $cost == ""){
	$sql= "UPDATE requestpost SET statusid='APPROVED' where prioritynumber ='$p' ";
	}else  {
	$sql= "UPDATE requestpost SET statusid='APPROVED' where prioritynumber ='$p' ";
