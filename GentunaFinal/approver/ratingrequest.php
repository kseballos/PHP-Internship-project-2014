...
//and g.prioritynumber=e.prioritynumber and g.departmentid='IT'")
//;
?>
...
<a href="remarksreq.php"><button class="btn btn-sm btn-primary-outline pull-right" type="submit">

   <i class="glyphicon glyphicon-chevron-right"></i>

   Remarks for Requests
...
if (document.getElementById) onload = function () {
	setInterval ("document.getElementById ('date-time').firstChild.data = new Date().toLocaleString()", 50)
              ...
              <div class="widget-content padded clearfix">
               ...
               <td > Total Submitted Request</td>
                    <td ><?php echo $rcount1; ?> </td>
					
					  </tr>
					 
					  <td ><font face="calibri"  color="#FF0000"> Total Rating for Request</font></td>
                    <td ><font face="calibri"  color="#FF0000"><?php echo $per1; ?>%
					  </font></td>
						</font> </td> </tr>
					<td> <font face="calibri"  color="#FF0000">Requests with Rating of 1.0 (49% and below of agreed performance standard)</font></td>
						<td> <font face="calibri"  color="#FF0000">						
						<?php echo $rcounts;?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rfinal; ?>%

									</font></td>
						
					  </tr>	
					   <td> <font face="calibri"  color="#FF0000">Requests with Rating of 2.00 (50-74% of the agreed performance standards)</font></td>
						<td> <font face="calibri"  color="#FF0000"><?php echo $rsu;?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rfinal2; ?>%
									</font></td>
						</tr>
						 <td> <font face="calibri"  color="#FF0000">Requests with Rating of 2.55 (75-84% of agreed performance standards)</font></td>
						<td> <font face="calibri"  color="#FF0000"><?php echo $racc;?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rfinal1; ?>%
									</font></td>
						</tr>
						 <td> <font face="calibri"  color="#FF0000">Requests with Rating of 3.00 (85-95% of agreed performance standards)</font></td>
						<td> <font face="calibri"  color="#FF0000"><?php echo $rex;?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rfinal3; ?>%
									</font></td>
						</tr>
						 <td> <font face="calibri"  color="#FF0000">Requests with Rating of 3.50 (96-104% of agreed performance standards)</font></td>
						<td> <font face="calibri"  color="#FF0000"><?php echo $rexb;?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rfinal3b; ?>%
									</font></td>
						</tr>
						 <td> <font face="calibri"  color="#FF0000">Requests  with Rating of 4.00 (105% and above of agreed performance standards)</font></td>
						<td> <font face="calibri"  color="#FF0000"><?php echo $rexm;?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rfinal3m; ?>%
									</font></td>
						</tr>
                  </tbody>
                </table>
