			  ...
			  <div id="tablescroll">
                <table class="table table-bordered table-striped" id="dataTable1">
				  ...
				  <?php
									...
									$sql =" SELECT r.hourscompleted,r.estimateddate,r.enddate,r.title, r.datetime , r.username , r.departmentid, r.businessunitid, r.statusid, r.availdate, r.prioritynumber
									FROM requestpost r" ;
					...
					if($dept == 'Information Technology' && $stat == 'Open'){
					echo  "<td class='actions'><a class='table-actions' href='approverequest.php?p=$prio'><i class='icon-pencil' title='Approve Request' ></i></a><i class='glyphicon glyphicon-ok'  title='Not allowed to Change Priority'> </i></a></td>"  ; 		
					  echo "</tr>";
							}
						else if($dept == 'Information Technology' && $stat == 'APPROVED'){
					echo  "<td class='actions'><i class='icon-pencil' title='Not allowed to Approve Request'></i><a class='table-actions' href='editrequest.php?p=$prio'><i class='glyphicon glyphicon-ok' title='Change Priority'  ></i></a></td>"  ; 		
					  echo "</tr>";
							}
							else if($dept == 'Information Technology' && $stat == 'ON-GOING'){
					echo  "<td class='actions'><i class='icon-pencil' title='Not allowed to Approve Request' ></i><a class='table-actions' href='editrequest.php?p=$prio'><i class='glyphicon glyphicon-ok' title='Change Priority' ></i></a></td>"  ; 		
					  echo "</tr>";
							}
							else if($dept == 'Information Technology' && $stat == 'CANCELLED'){
					echo  "<td class='actions'><i class='icon-pencil' title='Not allowed to Approve Request'></i><i class='glyphicon glyphicon-ok'  title='Not allowed to Change Priority' ></i></a></td>"  ; 		
					  echo "</tr>";
							}
							elseif($dept == 'Information Technology' && $stat == 'HOLD'){
					echo  "<td class='actions'><i class='icon-pencil' title='Not allowed to Approve Request' ></i><a class='table-actions' href='editrequest.php?p=$prio'><i class='glyphicon glyphicon-ok'  title='Change Priority'></i></a></td>"  ; 	
					  echo "</tr>";
							}
						else 	if($dept == 'Information Technology' && $stat == 'COMPLETED'){
					echo  "<td class='actions'><i class='icon-pencil'title='Not allowed to Approve Request' ></i><i class='glyphicon glyphicon-ok'  title='Not allowed to Change Priority'></></i></a></td>"  ; 	
					  echo "</tr>";
							}else 	if($dept == 'Information Technology' && $stat == 'ACKNOWLEDGED'){
					echo  "<td class='actions'><i class='icon-pencil'title='Not allowed to Approve Request' ></i><i class='glyphicon glyphicon-ok'  title='Not allowed to Change Priority'></></i></a></td>"  ; 	
					  echo "</tr>";
							}
							else{
					echo 
					   "<td class='actions'><i class='icon-pencil' title='Not allowed to Approve Request'></i><i class='glyphicon glyphicon-ok'   title='Not allowed to Change Priority'></></i></a></td>"  ; 					   
                    echo "</tr>";
                   // }
				   }
                   ...
                   // }
					...
					//"<td class='actions'><div class='action-buttons'><a class='table-actions' href='editrequest.php?p=$prio'><i class='icon-pencil' ></i></a></div>"  ; 
					 // 	"<td class='actions'><div class='action-buttons'><i class='icon-pencil' ></i></div>" ;
					 // echo "</tr>";
					
					
					}
					
				//	echo $username1, $user1;
