			  ...
			  <div id="tablescroll">
                <table class="table table-bordered table-striped" id="dataTable1">
				  ...
				  <?php
					...
					if($dept == 'Facilities and Engineering Department' && $stat == 'Open'){
					echo  "<td class='actions'><a class='table-actions' href='approvejoborder.php?p=$prio'><i class='icon-pencil' title='Approve Job Order' ></i></a><i class='glyphicon glyphicon-ok'  title='Not allowed to Change Priority'> </i></a></td>"  ; 		
					  echo "</tr>";
							}
						else if($dept == 'Facilities and Engineering Department' && $stat == 'APPROVED'){
					echo  "<td class='actions'><i class='icon-pencil' title='Not allowed to Approve Job Order'></i><a class='table-actions' href='editjoborder.php?p=$prio'><i class='glyphicon glyphicon-ok' title='Change Priority'  ></i></a></td>"  ; 		
					  echo "</tr>";
							}
							else if($dept == 'Facilities and Engineering Department' && $stat == 'ON-GOING'){
					echo  "<td class='actions'><i class='icon-pencil' title='Not allowed to Approve Job Order' ></i><a class='table-actions' href='editjoborder.php?p=$prio'><i class='glyphicon glyphicon-ok' title='Change Priority' ></i></a></td>"  ; 		
					  echo "</tr>";
							}
							else if($dept == 'Facilities and Engineering Department' && $stat == 'CANCELLED'){
					echo  "<td class='actions'><i class='icon-pencil' title='Not allowed to Approve Job Order'></i><i class='glyphicon glyphicon-ok'  title='Not allowed to Change Priority' ></i></a></td>"  ; 		
					  echo "</tr>";
							}
							elseif($dept == 'Facilities and Engineering Department' && $stat == 'HOLD'){
					echo  "<td class='actions'><i class='icon-pencil' title='Not allowed to Approve Job Order' ></i><a class='table-actions' href='editjoborder.php?p=$prio'><i class='glyphicon glyphicon-ok'  title='Change Priority'></i></a></td>"  ; 	
					  echo "</tr>";
							}
						else 	if($dept == 'Facilities and Engineering Department' && $stat == 'COMPLETED'){
					echo  "<td class='actions'><i class='icon-pencil'title='Not allowed to Approve Job Order'> </i><i class='glyphicon glyphicon-ok'  title='Not allowed to Change Priority'></></i></a></td>"  ; 	
					  echo "</tr>";
							}else 	if($dept == 'Facilities and Engineering Department' && $stat == 'ACKNOWLEDGED'){
					echo  "<td class='actions'><i class='icon-pencil'title='Not allowed to Approve Job Order'> </i><i class='glyphicon glyphicon-ok'  title='Not allowed to Change Priority'></></i></a></td>"  ; 	
					  echo "</tr>";
							}
							else{
					echo 
					   "<td class='actions'><i class='icon-pencil' title='Not allowed to Approve Job Order' ></i><i class='glyphicon glyphicon-ok'   title='Not allowed to Change Priority'></></i></a></td>"  ; 					   
                    echo "</tr>";
                   // }
				   }
