  ...
  <body>
    <div class="modal-shiftfix">
	 ...
	 <?php
									...
									$sql =(" SELECT hourscompleted,estimateddate,enddate,title, datetime , username ,departmentid, businessunitid, statusid, availdate, prioritynumber,rateequivalent
					...
					echo  "<td class='actions'><i class='glyphicon glyphicon-time' title='Not allowed to Change Schedule'></i></td>"  ; 		
					  echo "</tr>";
							}
						else if($dept == 'Information Technology' && $stat == 'APPROVED'){
					echo  "<td class='actions'><a class='table-actions' href='editrequest.php?p=$prio'><i class='glyphicon glyphicon-time'  title='Change Schedule' ></i></a></td>"  ; 		
					  echo "</tr>";
							}
							else if($dept == 'Information Technology' && $stat == 'ON-GOING'){
					echo  "<td class='actions'><a class='table-actions' href='editrequest.php?p=$prio' ><i class='glyphicon glyphicon-time'  title='Change Schedule' ></i></a></a></td>"  ; 		
					  echo "</tr>";
							}
							else if($dept == 'Information Technology' && $stat == 'CANCELLED'){
					echo  "<td class='actions'><i class='glyphicon glyphicon-time' title='Change Schedule' ></i></td>"  ; 		
					  echo "</tr>";
							}
					...
					echo 
					   "<td class='actions'><i class='glyphicon glyphicon-time'  title='Not allowed to Change the Schedule!' ></i></a></td>"  ; 					   
                    echo "</tr>";
