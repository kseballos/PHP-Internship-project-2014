              ...
              <div class="widget-content padded clearfix">
			   <div id="tablescroll">
				...
				if($dept == 'Facilities and Engineering Department' && $stat == 'Open'){
					...
					echo  "<td class='actions'><a class='table-actions' href='editjoborder.php?p=$prio'><i class='glyphicon glyphicon-time'  title='Change Schedule' ></i></a></td>"  ; 		
					  echo "</tr>";
							}
							else if($dept == 'Facilities and Engineering Department' && $stat == 'ON-GOING'){
					echo  "<td class='actions'><a class='table-actions' href='editjoborder.php?p=$prio' ><i class='glyphicon glyphicon-time'  title='Change Schedule' ></i></a></a></td>"  ; 		
					  echo "</tr>";
							}
