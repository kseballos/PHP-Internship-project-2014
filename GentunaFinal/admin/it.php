			  ...
			  <div id="tablescroll">
                <table class="table table-bordered table-striped" id="dataTable1">
				  ...
				  <?php
					...
					if( $stat == 'Open'){
					echo  "<td class='actions'><a class='table-actions' href='approverequest.php?p=$prio'><i class='icon-pencil' title='Approve job order'></i></a><i class='glyphicon glyphicon-ok' title='Not allowed to complete Job Order'></i></a><i class='glyphicon glyphicon-time' title='Not allowed to Change Schedule'></i></td>"  ; 		
					  echo "</tr>";
							}
						else if($stat == 'APPROVED'){
					echo  "<td class='actions'><i class='icon-pencil' title='Not allowed to Approve Job Order' ></i><a class='table-actions' href='completed.php?p=$prio'><i class='glyphicon glyphicon-ok' title='Complete Job Order' ></i></a><a class='table-actions' href='editjrequest.php?p=$prio'><i class='glyphicon glyphicon-time'  title='Change Schedule' ></i></a></td>"  ; 		
					  echo "</tr>";
							}
							else if( $stat == 'ON-GOING'){
					echo  "<td class='actions'><i class='icon-pencil' title='Not allowed to approve Job Order'></i></a><a class='table-actions' href='completed.php?p=$prio'><i class='glyphicon glyphicon-ok' title='Complete Job Order' ></i></a><a class='table-actions' href='editjrequest.php?p=$prio'><i class='glyphicon glyphicon-time'  title='Change Schedule' ></i></a></td>"  ; 		
					  echo "</tr>";
							}
							else if( $stat == 'CANCELLED'){
