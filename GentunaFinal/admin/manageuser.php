          ...
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
              <div class="heading" align="center">
                <i class="icon-table"></i> Manage User Account
				<a href="adduser.php"><button class="btn btn-sm btn-primary-outline pull-right" type="submit">
			  ...
			  <div id="tablescroll">
                <table class="table table-bordered table-striped" id="dataTable1">
				  ...
				  <?php
					...
					echo 
					"<td class='actions'><div class='action-buttons'><a class='table-actions' href='edituse.php?p=$prio'><i class='icon-pencil' ></i></div>" ;					 
					echo "</tr>";				
