...
<head>
	  ...
	  <div class="row">
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
              <div class="heading">
                <i class="icon-table"></i>User Accounts
 ...
 <?php
									...
									$sql6=mysql_query("select count(j.username) as countBDA from loginacc j, approver r where j.username=r.username ");
									$row6=mysql_fetch_array($sql6);
									$countBDA=$row6['countBDA'];

									$sql7=mysql_query("select count(j.username) as count from loginacc j , scheduler r where j.username=r.username ");
									$row7=mysql_fetch_array($sql7);
									$count=$row7['count'];
									
									$sql1=mysql_query("select count(j.username) as count2 from loginacc j ,user r where j.username= r.username ");
					...
					<td class='actions'><a class='table-actions' href='manageapp.php'><i class="glyphicon glyphicon-eye-open" ></i>	</td>
					  </tr>
					   <td > Scheduler</td>
                    <td ><?php echo $count; ?> </td>
					<td class='actions'><a class='table-actions' href='managesched.php'><i class="glyphicon glyphicon-eye-open" ></i></div>	</td>
					
					  </tr>
					   <td > User</td>
                    <td ><?php echo $count2; ?> </td>
					<td class='actions'><a class='table-actions' href='manageuser.php'><i class="glyphicon glyphicon-eye-open" ></i></div>	</td>
