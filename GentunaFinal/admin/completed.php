...
$monthtodel = '0'.$monthtodelete . '/' .$datenow;
	...
	{
	$sql= "UPDATE requestpost SET title='$title', username='$user', departmentid='$depta', businessunitid='$businessunitid', unitid='$unitid', tid='$tid', availdate='$aadate', statusid='COMPLETED', remarks='$remarks' , cost='$cost',instruct='$inst' , date_to_delete='$monthtodel' , hourscompleted= '$try'  where prioritynumber='$p' ";
	echo $sql;
	$result = mysql_query($sql);
	}else{
	$sql= "UPDATE requestpost SET title='$title', username='$user', departmentid='$depta', businessunitid='$businessunitid', unitid='$unitid', tid='$tid', statusid='COMPLETED', remarks='$remarks' , cost='$cost',instruct='$inst' , date_to_delete='$monthtodel', hourscompleted= '$try' where prioritynumber ='$p' ";
	$result = mysql_query($sql);
	}
