...
<head>
  ...
  <div class="col-md-12">
    <div class="widget-container">
      <div class="heading">
        <i class="icon-shield"></i>Delete Remarks for Requests
      </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="firstname">Delete from Date(MM/DD/YYYY)</label><input class="form-control" name="delf" type="text">
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="lastname">Delete to Date(MM/DD/YYYY)</label><input class="form-control"  name="delt" type="text">
                </div>
   ...
   <i class="glyphicon glyphicon-chevron-left"></i>
                ...
                <table class="table table-bordered table-striped" id="dataTable1">
                  ...
                  <tbody>
				   <?php
									...
									$sql6=("SELECT t.title, r.ratevalue, t.assignedper,r.departmentid, r.remarks FROM `rating` r, `requestpost` t WHERE t.prioritynumber = r.prioritynumber and r.departmentid='IT' ");
	...
	$sql1= "delete  FROM rating using rating inner join requestpost WHERE rating.prioritynumber=requestpost.prioritynumber and rating.departmentid='FED' and requestpost.date_to_delete  BETWEEN '$delf' AND '$delt'";
	$result=mysql_query($sql1) or die(mysql_error());
	if($result){
echo "<script type=\"text/javascript\">window.location.href='remarksreq.php' </script>";
}
else {
