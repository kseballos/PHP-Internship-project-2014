...
<head>
  ...
  <div class="col-lg-12">
    <div class="widget-container fluid-height clearfix">
      <div class="heading">
        <i class="icon-reorder"></i>Add Department
      </div>
	  
      <div class="widget-content padded">
	 
        <form action="adddepartment.php" class="form-horizontal" method="POST">
        <div class="form-group">
            <label class="control-label col-md-2">Department ID<font face="calibri" color="#FF0000">* </font></label>
            <div class="col-md-7">
              <input class="form-control" placeholder="Department ID" type="text" name="deptaid" required >
            </div>
			</div>
			 <div class="form-group">
            <label class="control-label col-md-2">Department Name<font face="calibri" color="#FF0000">* </font></label>
            <div class="col-md-7">
              <input class="form-control" placeholder="Department Name" type="text" name="deptaname" required >
            </div>
			</div>
			   </div>
			<div>
