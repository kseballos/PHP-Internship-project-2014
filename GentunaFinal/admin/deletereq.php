...
<head>
  ...
  <div class="col-md-12">
    <div class="widget-container">
      <div class="heading">
        <i class="icon-shield"></i>Delete Remarks for Job Orders
      </div>
   ...
   <i class="glyphicon glyphicon-chevron-left"></i>
	...
	$sql1= "delete  FROM rating using rating inner join joborderdetails WHERE rating.prioritynumber=joborderdetails.prioritynumber and rating.departmentid='FED' and joborderdetails.date_to_delete  BETWEEN '$delf' AND '$delt'";
	$result=mysql_query($sql1) or die(mysql_error());
	if($result){
echo "<script type=\"text/javascript\">window.location.href='remarks.php' </script>";
}
else {
