...
$monthtodel = '0'.$monthtodelete . '/' .$datenow;
	...
	if($adate1 != ""){
	$sql= "UPDATE joborderdetails SET projectname='$projectname',  departmentid='$departmentid', section='$section', datereq='$datereq',  remarks='$remarks' , estimatedcost='$estimatedcost' , date_to_delete='$monthtodel', statusid='COMPLETED' , hourscompleted= '$try' where prioritynumber ='$p' ";

	}else {
	$sql= "UPDATE joborderdetails SET projectname='$projectname',  departmentid='$departmentid', section='$section', datereq=NULL,  remarks='$remarks' , estimatedcost='$estimatedcost' ,date_to_delete='$monthtodel' ,statusid='COMPLETED',hourscompleted= '$try'  where prioritynumber ='$p' ";
