	  ...
	  <div class="row">
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
              <div class="heading">
                <i class="icon-table"></i>Remarks for Request
				<a href="remarks.php"><button class="btn btn-sm btn-primary-outline pull-right" type="submit">

   <i class="glyphicon glyphicon-chevron-right"></i>

   Remarks for Job Orders

</button></a>
				<a href="deleterequest.php"><button class="btn btn-sm btn-primary-outline pull-right" type="submit">
