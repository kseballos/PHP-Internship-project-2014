          ...
          <div class="nav-collapse">
            <ul class="nav">
			  ...
			  <li><a href="useraccounts.php">
			   ...
			   <li><a class="current" href="department.php">
          ...
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
              <div class="heading">
				...
				<a href="add.php"><button class="btn btn-sm btn-primary-outline pull-right" type="submit">
			  ...
			  <div id="tablescroll">
                <table class="table table-bordered table-striped" id="dataTable1">
				  ...
				  <?php
					...
					echo  "<td class='actions'><a class='table-actions' href='editdepartment.php?p=$prio'><i class='icon-pencil' title='Edit Department'></i></a></td>"  ; 		
					  echo "</tr>";
