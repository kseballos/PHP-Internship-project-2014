...
<head>
  ...
  <body>
          ...
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
              <div class="heading" align="center">
                <i class="icon-table"></i> Edit Scheduler Account
	...
	$sql= "UPDATE user SET username='$user', first='$first', departmentid='$deptid', last='$last' where username ='$p' ";
	$insert1 = mysql_query($sql);
	$sql1= "UPDATE loginacc SET username='$user', password='$pass' where username ='$p' ";
