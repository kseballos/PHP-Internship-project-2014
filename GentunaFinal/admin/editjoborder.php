...
<?php
	...
	$sql= "UPDATE joborderdetails SET projectname='$projectname', departmentid='$departmentid', section='$section', datereq='$datereq', remarks='$remarks' ,statusid='$statu', estimatedcost='$estimatedcost',instruct='$inst', estimateddate='$esti' , assignedper='$assign', enddate='$enddate' where prioritynumber ='$p' ";

	}else {
	$sql= "UPDATE joborderdetails SET projectname='$projectname',  departmentid='$departmentid', section='$section', datereq='$datereq', remarks='$remarks' ,statusid='$statu',estimatedcost='$estimatedcost',instruct='$inst' ,estimateddate='$esti' , enddate='$enddate' ,assignedper='$assign' where prioritynumber ='$p' ";
