...
$p=@$_GET['p'];	
$sql=mysql_query("SELECT l.password ,s.username,d.deptname, s.first,s.last FROM loginacc l,scheduler s ,department d where  s.departmentid=d.deptname and s.username = '$p'");
