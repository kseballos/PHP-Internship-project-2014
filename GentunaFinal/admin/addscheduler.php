...
<head>
  ...
  <body>
          ...
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
              <div class="heading" align="center">
                <i class="icon-table"></i> Add Scheduler Account
	...
	$sql= "INSERT into scheduler (username,first,departmentid,last) VALUES ('$user', '$first', '$deptid','$last') ";
	$insert1 = mysql_query($sql);
	$sql1= "INSERT into loginacc (username,usertype,password) VALUES ('$user','scheduler','$pass' )";
