...
<head>
  ...
  <div class="col-lg-12">
    ...
    <div class="widget-container fluid-height clearfix">
	  <div class="heading">
        <i class="icon-reorder"></i>Edit Schedule for Request
      </div>
        ...
        <div class="form-group">
		  ...
		  <div class="form-group">
		   ...
		   <div class="form-group">
            ...
            <div class="col-md-7">
              <input class="form-control" placeholder="Text" type="text" name="enddate" value="<?php echo $end; ?>" required >
            </div>
			</div>
			<div class="form-group">
		  ...
		  <div class="form-group">
            ...
            <div class="col-md-7">
              <input class="form-control" rows="2" name="instruct"  value=" <?php echo $inst; ?>" ></input>
            </div class="form-group">
...
<?php
	...
	if($adate1 != ""){
	$sql= "UPDATE requestpost SET title='$title', departmentid='$depta', businessunitid='$businessunitid', unitid='$unitid', tid='$tid', availdate='$adate', statusid='$statu',  remarks='$remarks' , cost='$cost',instruct='$inst', estimateddate='$esti' , assignedper='$assign' ,enddate='$enddate' where prioritynumber ='$p' ";

	}else  {
	$sql= "UPDATE requestpost SET title='$title',  departmentid='$depta', businessunitid='$businessunitid', unitid='$unitid', tid='$tid', availdate= NULL ,statusid='$statu',  remarks='$remarks' , cost='$cost',instruct='$inst', estimateddate='$esti' , assignedper='$assign' ,enddate='$enddate' where prioritynumber ='$p' ";
