...
<head>
  ...
  <body>
          ...
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
              <div class="heading" align="center">
                <i class="icon-table"></i> Add User Account
				
				<a href="manageuser.php"><button class="btn btn-sm btn-primary-outline pull-right" type="submit">
	...
	$sqla="Select * department";
	$seldept = mysql_query($sqla);
	
	$sql= "INSERT into user (username,first,departmentid,last) VALUES ('$user', '$first', '$deptid','$last') ";
	$insert1 = mysql_query($sql);
	$sql1= "INSERT into loginacc (username,usertype,password) VALUES ('$user','user','$pass' )";
	$insert2 = mysql_query($sql1);
	
if($insert1){
echo "<script type=\"text/javascript\">window.location.href='manageuser.php' </script>";
}
else if($insert2){
echo "<script type=\"text/javascript\">window.location.href='manageuser.php' </script>";
}
