...
include '././dbconnection/connect.php';
	...
	if($adate != ""){
	$sql= "INSERT INTO requestpost (title, username, departmentid, businessunitid, unitid, tid, availdate, datetime, remarks) VALUES ('$title', '$user',
	'$depta', '$busse', '$unita', '$trouba' , '$adate', NOW() , '$rem')";
	}else{
