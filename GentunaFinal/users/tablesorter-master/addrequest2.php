        ...
        <form action="addreq.php" class="form-horizontal" method="POST">
		  ...
		  <div class="form-group">
		   ...
		   <div class="form-group">
            ...
            <div class="col-md-7">
              <select class="form-control" name="tid"><?php
									$college="SELECT * FROM trouble ORDER BY tname ASC";
									$resultcoll=mysql_query($college);
									?>
									<?php
									while($rows1=mysql_fetch_array($resultcoll)){
									?>
									<option ><?php echo $rows1['tname'];  ?></option>
									<?php
								}
								?></option></select>
            </div>
		  ...
		  <div class="form-group">
            ...
            <div class="col-md-7">
              <select class="form-control" name="unitid"><?php
