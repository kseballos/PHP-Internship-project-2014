        ...
        <form action="addreq3.php" class="form-horizontal" method="POST">
          <div class="form-group">
            ...
            <div class="col-md-7">
              ...
              <input class="form-control" placeholder="Text" type="text" name="title" required >
		  ...
		  <div class="form-group">
            ...
            <div class="col-md-7">
              <input class="form-control" placeholder="Text" type="text" name="businessunitid" required>
            </div>
			</div>
		   ...
		   <div class="form-group">
            ...
            <div class="col-md-7">
              <input class="form-control" name="tid"required>
            </div>
          </div>
		  ...
		  <div class="form-group">
            ...
            <div class="col-md-7">
              <input class="form-control" name="unitid" required>
            </div>
          </div>
		  <div class="form-group">
            <label class="control-label col-md-2" for="adate">Date Required (YYYY-MM-DD)<font face="calibri" color="#FF0000">* </font></label>
            <div class="col-md-7">
              <input class="form-control" placeholder="Text" type="text" name="availdate" required>
            </div>
			</div>
		       <div class="form-group">
