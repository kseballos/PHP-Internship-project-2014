...
<head>
  ...
  <div class="col-lg-12">
	   ...
	   <div class="heading">
        <i class="icon-reorder"></i>Complete Job Order
      </div>
...
<div id = "tablescroll">
		   ...
		   <div class="form-group">
            ...
            <div class="col-md-7">
              <select class="form-control" name="departmentid" readonly >
			  						<option ><?php echo $departmentid; ?></option>		</select>
          </div>
		  </div>
	...
	$sql = "SELECT * FROM joborderdetails where prioritynumber = '$p'";
...
$monthtodel = $monthtodelete . '/' .$datenow;
	...
	$estimatedcost = $_POST['cost'];
	
	if($adate1 != ""){
	$sql= "UPDATE joborderdetails SET projectname='$projectname', username='$user', departmentid='$departmentid', section='$section', datereq='$datereq',  remarks='$remarks' , estimatedcost='$estimatedcost' , date_to_delete='$monthtodel', statusid='ACKNOWLEDGED' , hourscompleted= '$try' where prioritynumber ='$p' ";

	}else {
	$sql= "UPDATE joborderdetails SET projectname='$projectname', username='$user', departmentid='$departmentid', section='$section', datereq=NULL,  remarks='$remarks' , estimatedcost='$estimatedcost' ,date_to_delete='$monthtodel' ,statusid='ACKNOWLEDGED',hourscompleted= '$try'  where prioritynumber ='$p' ";
	...
	if($result){
echo "<script type=\"text/javascript\">window.location.href='rating1.php?p=$p' </script>";
}
else {
