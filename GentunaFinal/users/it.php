...
$Ddatenow = date('m/d/Y');
mysql_query("DELETE FROM requestpost WHERE date_to_delete = '$Ddatenow'");
?>
	  ...
	  <div class="row">
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
              <div class="heading">
                <i class="icon-table"></i>Requests 
				<a href="addrequesttry.php"><button class="btn btn-sm btn-primary-outline pull-right" type="submit">
              ...
              <div class="widget-content padded clearfix">
                ...
                <table class="table table-bordered table-striped" id="dataTable1">
				 ...
				 <?php
									...
									$sql1 =" SELECT hourscompleted,estimateddate,enddate,title, datetime , username ,departmentid, businessunitid, statusid, availdate, prioritynumber,rateequivalent
									FROM requestpost order by username ASC" ;
					...
					echo "<td class='actions'><div class='action-buttons'><a class='table-actions' href='editrequest.php?p=$prio'><i class='icon-pencil' title='Edit Request'></a></i><i class='glyphicon glyphicon-ok' title='Not allowed to Acknowledge Request'></i></a> </div>"  ; 
					  echo "</tr>";
							}
					...
					echo "<td class='actions'><div class='action-buttons'><i class='icon-pencil' title='Not allowed to Change Details'></i><a class='table-actions' href='completed.php?p=$prio'><i class='glyphicon glyphicon-ok' title='Not allowed to Acknowledge Request' ></i></a></div>"  ;
					  echo "</tr>";
							}
					else {
					  
					  echo 
					"<td class='actions'><div class='action-buttons'><i class='icon-pencil' title='Not allowed to Change Details'></i><i class='glyphicon glyphicon-ok' title='Not allowed to Acknowledge Request'  ></i>  </div>" ;
