...
<head>
  ...
  <div class="col-lg-12">
    <div class="widget-container fluid-height clearfix">
      <div class="heading">
        <i class="icon-reorder"></i>Account
      </div>
      <div class="widget-content padded">
	 
        <form action="changepass.php" class="form-horizontal" method="get">
		   ...
		   <div class="form-group">
			...
			?>
              <input class="form-control" placeholder="Confirm Password" type="password" name="pass" value="<?php echo $pass?>;"readonly>
            </div>
			</div>
